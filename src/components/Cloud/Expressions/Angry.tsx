...
const Angry: React.FC<IExpressionProps> = ({
  ...
  const getEyes = () => (
    <g>
      ...
      <line
        fill="none"
        strokeLinecap="round"
        strokeWidth={character?.eyebrowStroke}
        transform={character?.rightEyebrowTransform}
        stroke={strokeColor}
        strokeMiterlimit="10"
        x1="145"
        y1="100"
      ...
      <line
        ...
        strokeLinecap="round"
        strokeWidth={character?.eyebrowStroke}
        transform={character?.leftEyebrowTransform}
        stroke={strokeColor}
        strokeMiterlimit="10"
        x1="40"
        y1="92"
  ...
  const getMouth = () => (
    <line
      ...
      stroke={strokeColor}
      strokeMiterlimit="10"
      transform={character?.angryMouthTransform}
      x1="88"
      y1="129"
      x2="119"
      y2="129"
